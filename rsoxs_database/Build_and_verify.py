...
acquisition_schema = load_schema('RSoXS_Acquisition.json')
...
def build_and_verify_user(*,date_list=[],email='', first_name='User', institution_id=0,
                          ...
                          proposal_id=0, user_id=0, username='CantFollowDirections', history=[], priority=0):

    user = {
        'date_checkin_list': date_list,
        'email': email,
...
def build_and_verify_sample(*, sample_name='test', sample_desc='testing',
                            ...
                            past_bar_ids=[], location_id=0, requests=[], history=[],priority=0):
